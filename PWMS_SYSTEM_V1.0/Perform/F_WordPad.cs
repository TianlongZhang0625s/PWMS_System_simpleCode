    ...
    public partial class F_WordPad : Form
    {
        ...
        private void Word_Save_Click(object sender, EventArgs e)
        {
            ...
            if (Word_S == 1)
            {
                ...
                MyDataClass.GetA_M_D_command("insert into tb_DayWordPad (" + All_Field + ") values(" + All_Value + ")");
            }
            if (Word_S == 2)
            {
                ...
                MyDataClass.GetA_M_D_command("update tb_DayWordPad set " + All_Value + " where ID='" + Word_ID + "'");
            }
        ...
        private void Word_Delete_Click(object sender, EventArgs e)
        {
            ...
            MyDataClass.GetA_M_D_command("Delete tb_DayWordPad where ID='" + Word_ID + "'");
            Word_Cancel_Click(sender, e);
        }
